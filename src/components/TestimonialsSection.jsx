...
export default function TestimonialsSection() {
  ...
  async function handleSubmit(event) {
    ...
    if (supabase) {
      const { error } = await supabase.from('testimonials').insert(request);
      if (error) return;
    }
